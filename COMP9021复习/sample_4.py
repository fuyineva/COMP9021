...
#    if word_1 not in lexicon or word_2 not in lexicon or word_1 != candidate_ladder[0] or word_2 != candidate_ladder[-1] \
#        or len(word_1)!=len(word_2):
#            return False
#    for i in candidate_ladder:
#        if i not in lexicon or len(i) != len(word_1):
#            return False
#    
...
#    a.append([word_1])
#    while True:
#        change_words_list = a.popleft()
#        if change_words_list[-1] != word_2:
#            for i in closest_words[change_words_list[-1]]:
#                if i not in change_words_list:
#                    a.append(change_words_list+[i])
#        if change_words_list[-1] == word_2:
#            if len(change_words_list)<len(candidate_ladder):
#                return False
#            else:
#                break
#    return True
...
#        
#
#    if word_1 not in lexicon or word_2 not in lexicon or any(i not in lexicon for i in candidate_ladder) or len(word_1) != len(word_2) \
#       or word_1 != candidate_ladder[0] or word_2 != candidate_ladder[-1]:
#        print(False)
#        return
#    step = len(candidate_ladder)
#    for i in range(len(candidate_ladder) - 1):
#        if candidate_ladder[i + 1] not in closest_words[candidate_ladder[i]]:
#            print(False)
#            return
...
#                break
#        else:
#            for i in closest_words[words[-1]]:
#                if i not in words:
#                    new_words = words + [i]
#                    deq.append(new_words)
#    print(True)
#        
#    
